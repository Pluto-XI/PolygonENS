// SPDX-License-Identifier: ULNICENSED
...
contract Domains is ERC721URIStorage{
    //OpenZeppelin allows us to keep a track of tokenIds.
    ...
    function register(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Cloud Name Service", "image": "data:image/svg+xml;base64,',
    ...
    //This gets the wallet address of the domain owner. calldata indicates where our argument should be stored.
    //Call data is not persistent and can't be modified. public is a visibility modifier, it lets everyone hit the function, including other contracts
    //view means the function is only viewing data on the contract, not modifying
    //returns, returns our domain owner's wallet address as the native solidity address type.
